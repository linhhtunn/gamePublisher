...
export function DevelopersSection() {
  ...
  const services = [
    { icon: Rocket, title: 'Global Publishing & Store Optimization', description: 'Expert ASO and market positioning', gradient: 'from-[#0ea5e9] to-[#2dd4bf]' },
    { icon: Zap, title: 'Creative Testing & Marketing Scale', description: 'Rapid iteration and scaled campaigns', gradient: 'from-[#f97316] to-[#fbbf24]' },
    { icon: BarChart3, title: 'Monetization Design & Analytics', description: 'Deep integration and optimization', gradient: 'from-[#d946ef] to-[#f43f5e]' },
    { icon: Code, title: 'LiveOps Strategy & Retention', description: 'Keep players engaged long-term', gradient: 'from-[#22c55e] to-[#14b8a6]' },
  ];
  ...
  return (
    <section ref={sectionRef} className="relative py-32 px-6 overflow-hidden">
     ...
     <div className="flex items-center justify-center grid lg:grid-cols-2 gap-20 ">
          ...
          {/* CỘT TRÁI: ẢNH HÌNH CHỮ NHẬT SẮC NÉT & SÁNG VIỀN KHI HOVER */}
          <motion.div 
          ...
          >
            ...
            <div className="relative rounded-[22px] overflow-hidden aspect-[16/10] bg-[#0a0a0a]">
              <img 
                src="https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1200&q=80" // Sử dụng ảnh chất lượng cao, q=80 để sắc nét
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                >
                  ...
                  />
                  <motion.div 
                    className="relative z-10 w-14 h-14 bg-blue-500/20 rounded-full flex items-center justify-center border border-blue-500/30 hover:bg-blue-500/30 transition-all"
                    animate={{
                      boxShadow: [
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6, delay: 0.2 }}
              className="text-xl text-gray-300 mb-8 w-150"
            >
              We partner with ambitious studios to unlock the full potential of their games.
            </motion.p>
                        <motion.h3
              initial={{ opacity: 0, y: 40 }}
              whileInView={{ opacity: 1, y: 0 }}
